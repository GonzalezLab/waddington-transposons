...
#SBATCH --job-name=obtain_freq_D907_A
#SBATCH --cpus-per-task=4
#SBATCH --partition=normal
#SBATCH -o logs/obtain_freq_D907_A_%a.out
#SBATCH -e logs/obtain_freq_D907_A_%a.err  
...
# sbatch --array=1-1097%50 obtainfreq_all_TEs_D907_A.sh
