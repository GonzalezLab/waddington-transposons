...
#SBATCH --job-name=obtain_freq_Mix_N
#SBATCH --cpus-per-task=4
#SBATCH --partition=normal
#SBATCH -o logs/obtain_freq_Mix_N_%a.out
#SBATCH -e logs/obtain_freq_Mix_N_%a.err  
...
# sbatch --array=1-1391%50 obtainfreq_all_TEs_Mix_N.sh
